...
def homepageleaders(idx_data, LeagueID=enums.LeagueID.Default, StatCategory=enums.StatCategory.Default, Season=enums.Season.Default,
...
def homepagev2(idx_data, LeagueID=enums.LeagueID.Default, StatType=enums.StatType.Default, Season=enums.Season.Default,
               SeasonType=enums.SeasonType.Default, PlayerOrTeam=enums.PlayerOrTeam.Default,
               GameScope=enums.GameScope.Default, PlayerScope=enums.PlayerScope.Default):
    """
...
def leaderstiles(idx_data, LeagueID=enums.LeagueID.Default, Stat=enums.Stat.Default, Season=enums.Season.Default,
                 SeasonType=enums.SeasonType.Default, PlayerOrTeam=enums.PlayerOrTeam.Default,
                 GameScope=enums.GameScope.Default, PlayerScope=enums.PlayerScope.Default):
    """
    Get top 5 players/teams by a particular stat.
    ...
    r = request_data(params, endpoint)
    df = parse_result_json(r, idx_data, 'resultSet')
    return df
